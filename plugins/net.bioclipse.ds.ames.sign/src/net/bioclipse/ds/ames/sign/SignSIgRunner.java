...
public class SignSIgRunner extends AbstractDSTest implements IDSTest{
    ...
    public static svm_model amesModel;
    ...
    public void initialize(IProgressMonitor monitor) throws DSException {
        ...
        //===================================
        try {
            amesModel = svm.svm_load_model(modelPath);
        } catch (IOException e) {
    ...
    private double partialDerivative(int component)
    {
        ...
        svm.svm_predict_values(amesModel, xScaled, decValues);
    ...
    {
        prediction = svm.svm_predict(amesModel, xScaled);
...
//        		net.bioclipse.ds.ames.signatures.Activator.BURSI_RESULT_PROPERTY);
